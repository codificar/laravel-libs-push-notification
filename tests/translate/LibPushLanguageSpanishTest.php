...
// to run test: sail artisan test --filter LibPushLanguageSpanishTest
class LibPushLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/push-notification/src/resources/lang';
